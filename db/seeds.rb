...
TriviaQuestion.create([
  ...
  {question: "Where did Harry Potter originally sleep with the Dursey's?", category: "Harry Potter"},
  {question: "Who does Harry Potter first meet to take him to Hogwarts?", category: "Harry Potter"},
  {question: "Who died during Harry Potter's final escape from the Dursey household?", category: "Harry Potter"},
